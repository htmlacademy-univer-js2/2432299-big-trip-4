...
import { formatToLongDate } from '../utils/time-utils.js';
import { capitalize, getLastWord } from '../utils/common-utils.js';

import { ButtonLabel, FormType } from '../const.js';
...
const createPointEditTemplate = ({ state, destinations, offers, pointType }) => {
        ...
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input
              ...
              value="${ point.dateFrom ? formatToLongDate(dateFrom) : ''}"
              ${isDisabled ? 'disabled' : ''}
            >
            &mdash;
            ...
            <input
              ...
              type="text"
              name="event-end-time"
              value="${ point.dateTo ? formatToLongDate(dateTo) : ''}"
              ${isDisabled ? 'disabled' : ''}
            >
          </div>
