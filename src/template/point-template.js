...
import { formatToLongDate, formatToShortDate, formatToShortTime, getDuration } from '../utils/time-utils.js';
...
const createPointTemplate = ({ point, destination, offers }) => {
  ...
  return `
    <li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="${formatToLongDate(dateFrom)}">
          ${formatToShortDate(dateFrom)}
        </time>
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${formatToLongDate(dateFrom)}">
            ${formatToShortTime(dateFrom)}
            </time>
            &mdash;
            <time class="event__end-time" datetime="${formatToLongDate(dateTo)}">
            ${formatToShortTime(dateTo)}
            </time>
          </p>
